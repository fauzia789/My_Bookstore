...
const handleFavourite = async () =>{
  ...
  .put("https://my-bookstore-8ev1.onrender.com/api/v1/add-book-favourite", {}, {headers}

  );
  alert(response.data.message);
}
const handleCart = async () =>{
  const response = await axios.put("https://my-bookstore-8ev1.onrender.com/api/v1/add-to-cart" , {},
     {headers} );
     alert(response.data.message);
}
...
const handleDelete= async() =>{
  const response=await axios.delete("https://my-bookstore-8ev1.onrender.com/api/v1/delete-book",
    {headers}
  );
  alert(response.data.message);
  navigate("/all-books");
